...
class ActiveTriggers {
    ...
    get(data) {
        //@ts-ignore
        return client_1.default.triggers.getTrigger(data).then(res => res.data);
    }
    /**
     ...
     */
    list(data = {}) {
        return client_1.default.triggers.getActiveTriggers({
            query: data
...
//# sourceMappingURL=activeTriggers.js.map